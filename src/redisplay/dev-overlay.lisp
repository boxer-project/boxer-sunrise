  ...
  (if *show-dev-overlay*
    (drawing-on-window (*boxer-pane*)
      ...
      (with-pen-color (*blue*)
        ...
        (draw-string alu-seta code-font (format nil "mouse status: ~A" (bw::mouse-doc-status-place)) x (+ 30 (* 4 line-height)))
        (draw-string alu-seta code-font (format nil "mouse x: ~A" (bw::mouse-doc-status-x)) x (+ 30 (* 5 line-height)))
        (draw-string alu-seta code-font (format nil "mouse y: ~A" (bw::mouse-doc-status-y)) x (+ 30 (* 6 line-height)))
        (draw-string alu-seta code-font (format nil "popup-doc: ~A" (bw::mouse-doc-status-popup-doc)) x (+ 30 (* 7 line-height)))
        (draw-string alu-seta code-font (format nil "popup-x: ~A" (bw::mouse-doc-status-popup-x)) x (+ 30 (* 8 line-height)))
        (draw-string alu-seta code-font (format nil "popup-y: ~A" (bw::mouse-doc-status-popup-y)) x (+ 30 (* 9 line-height)))
        )))))
