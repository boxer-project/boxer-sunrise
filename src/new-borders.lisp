...
#|
                ...
                Copyright 2006 - 2012 Pyxisystems LLC
...
(defun draw-mouse-shrink-corner (x y)
  (with-pen-color (*mouse-doc-highlight-color*)
    (let ((half-x (+ x (floor *mouse-corner-highlight-size* 2)))
...
(defun draw-mouse-expand-corner (x y)
  (with-pen-color (*mouse-doc-highlight-color*)
    (let ((half-x (+ x (/ *mouse-corner-highlight-size* 2)))
...
(defun draw-mouse-resize-corner (x y)
  (let ((full-x (+ x *mouse-corner-highlight-size*))
        (full-y (+ y *mouse-corner-highlight-size*))
