...
;;;
;;; $Header: vars.lisp,v 1.0 90/01/24 22:19:04 boxer Exp $
;;;
;;; $Log:	vars.lisp,v $
;;;Revision 1.0  90/01/24  22:19:04  boxer
;;;Initial revision
;;;
#|
  ...
  Enhancements and Modifications Copyright 1998 - 2008 Pyxisystems LLC
