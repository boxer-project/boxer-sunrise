...
(defun default-light-theme ()
  (setf *background-color* (rgb-hex->rgb #(:rgb-hex "#FFFFFF"))
        *foreground-color* (rgb-hex->rgb #(:rgb-hex "#000000"))
        *default-border-color* (rgb-hex->rgb #(:rgb-hex "#000000")))
)

(defun solarized-dark-theme ()
  (setf *background-color* (rgb-hex->rgb *solarized-base03*)
        *foreground-color* (rgb-hex->rgb *solarized-base0*)
        *default-border-color* (rgb-hex->rgb *solarized-base1*))
)

(defun solarized-light-theme ()
  (setf *background-color* (rgb-hex->rgb *solarized-base3*)
        *foreground-color* (rgb-hex->rgb *solarized-base00*)
        *default-border-color* (rgb-hex->rgb *solarized-base02*)
  )
)
